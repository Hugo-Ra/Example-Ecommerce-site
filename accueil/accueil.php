...
if (!isset($_SESSION['Mdp'])) {
    header("Location: ../Compte/PreConnexion.html");
}
else{
?>
<!DOCTYPE html>
        ...
        $(document).ready(function() {
            ...
            $('.img-carrousel1').click(function() {
                    ...
                    if(currentWidth<121 && currentHeight<91) {
                        ...
                        $prevsuiv1.show(); // Affiche l'élément img-info1 lorsque l'image est cliquée
                        var $prevsuiv3 = $('#prevnext3');
                        $prevsuiv3.show(); // Affiche l'élément img-info1 lorsque l'image est cliquée
                        $('#img-bonus1').empty();
                        var $imgInfo1 = $('#img-info1');
                        $imgInfo1.hide();
                        var $action1 = $('#action1');
            ...
            $('.img-carrousel2').click(function() {
                    ...
                    if(currentWidth<121 && currentHeight<91) {
                        ...
                        $prevsuiv2.show(); // Affiche l'élément img-info2 lorsque l'image est cliquée
                        var $prevsuiv3 = $('#prevnext4');
                        $prevsuiv3.show(); // Affiche l'élément img-info2 lorsque l'image est cliquée
                        $('#img-bonus2').empty();
                        var $imgInfo2 = $('#img-info2');
                        $imgInfo2.hide();
                        var $action2 = $('#action2');
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="section">
            <?php
                $sql = "SELECT ID, Photo, Categorie, Etat, TypeVente FROM item ORDER BY ID DESC";
                ...
                if ($result) {
                    ...
                    echo "Problème lors de l'exécution de la requête SQL";
                }
            ?>
            <!-------------------------------------------Carousel Sélection du jour------------------------------------------->
            <h1 id="carou1">Sélection du jour</h1>
            <div id="encadre0">
                <div id="encadre1">
                    <div id="encadre2">
                        <div id="prevnext1">
                        ...
                        <div id="carrousel1">
                            <?php
                                ...
                                {
                                    $b += 1;
                                    if($b < 5 && $tab_typeVente[$i] == 'Ventes') {
                                        $a = $a + 1;
                                        echo '<img src="../img-articles/' . $df_item[$i][key($df_item[$i])][0] . '" width="100" height="90" id="' . key($df_item[$i]) .'" class="img-carrousel1">';
                                    }
                                    else {
                                        $b -= 1;
                                    }
                            ...
                            <div id="action1">
                                <?php if ($_SESSION['Statut'] == 'Acheteur') {?>
                                    <form id="ajoutPanier" method="POST" action="../panier/ajoutPanier.php">
                                        <input id="envoieID_item" type="hidden" name="envoieID_item">
                                        <input type="submit" name="ajout" value="Ajouter au panier">
                                    </form>
                                    <br>
                                    <form id="nego" method="post" action="../parcourir/chatroom.php">
                                        <input id="envoieID" type="hidden" name="envoieID">
                                        <input id="envoieID_article" type="hidden" name="envoieID_article">
                ...
                <div id="encadre1">
                    <div id="encadre2">
                        ...
                        <div id="carrousel2">
                            <?php
                                $a=0;
                                for ($i = count($df_item)-1; $i >= 0; $i--) {
                                    if ($tab_typeVente[$i] == 'Ventes') {
                                        $a = $a + 1;
                                ...
                                if ($a == 0)
                                {
                                    echo '<p id="vide">Aucun Articles</p>';
                                }
                            ?>
                            <br>
                        </div>
